...
type LimitOrderTranche struct {
	...
	PriceTakerToMaker github_com_duality_labs_duality_utils_math.PrecDec `protobuf:"bytes,7,opt,name=priceTakerToMaker,proto3,customtype=github.com/QuadrateOrg/core/x/dex/utils/math.PrecDec" json:"priceTakerToMaker" yaml:"priceTakerToMaker"`
}
