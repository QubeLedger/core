...
import (
	...
	keepertest "github.com/QuadrateOrg/core/x/dex/keeper/internal/testutils"
...
func simulateDeposit(ctx sdk.Context, app *app.QuadrateApp, addr sdk.AccAddress, deposit *types.DepositRecord) {
...
func TestUserDepositsAllQueryPaginated(t *testing.T) {
	app := quadrateapptest.Setup(t, "qube-1", false, 1)
