...
import (
	...
	ibclocalhosttypes "github.com/cosmos/ibc-go/v4/modules/light-clients/09-localhost/types"
...
func (k *Keeper) GetPortID(owner string) string {
	return fmt.Sprintf("%s%s", icatypes.PortPrefix, owner)
}
...
func (k *Keeper) RecalculateCValueLimits(ctx sdk.Context, hc *types.HostChain, mintedAmount, lsAmount sdk.Int) {
