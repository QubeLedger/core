...
func (k Keeper) GetPairIdDeposit(amountInt string, denom2 string) (string, error) {
...
func (k Keeper) GetPairIdWithdrawal(amountInt string, denom2 string) (string, error) {
	amountIntCoins, err := sdk.ParseCoinsNormalized(amountInt)
	if err != nil {
		return "", err
	}
