...
// source: github.com/QuadrateOrg/core/grow/loan.proto
...
type Loan struct {
	...
	CAmountpairId string `protobuf:"bytes,2,opt,name=cAmountpairId,proto3" json:"cAmountpairId,omitempty"`
...
func (*Loan) Descriptor() ([]byte, []int) {
	return fileDescriptor_5c5f0dfda172ca4e, []int{0}
}
...
func (m *Loan) GetCAmountpairId() string {
	if m != nil {
		return m.CAmountpairId
	}
	return ""
}
...
func init() {
	proto.RegisterType((*Loan)(nil), "github.com/QuadrateOrg/core.grow.Loan")
}

func init() { proto.RegisterFile("github.com/QuadrateOrg/core/grow/loan.proto", fileDescriptor_5c5f0dfda172ca4e) }

var fileDescriptor_5c5f0dfda172ca4e = []byte{
	// 175 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Loan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CAmountpairId) > 0 {
		i -= len(m.CAmountpairId)
		copy(dAtA[i:], m.CAmountpairId)
		i = encodeVarintLoan(dAtA, i, uint64(len(m.CAmountpairId)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
...
func (m *Loan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CAmountpairId", wireType)
			}
			...
			m.CAmountpairId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
