...
// source: quicksilver/interquery/v1/interquery.proto
...
func init() {
	proto.RegisterType((*Query)(nil), "quicksilver.interquery.v1.Query")
	proto.RegisterType((*DataPoint)(nil), "quicksilver.interquery.v1.DataPoint")
}

func init() {
	proto.RegisterFile("quicksilver/interquery/v1/interquery.proto", fileDescriptor_e12f0828e1ddee43)
}
...
var fileDescriptor_e12f0828e1ddee43 = []byte{
	...
	,
	...
	0xd5, 0x88, 0x9c, 0xb7, 0xcc, 0x31, 0xbd, 0xf8, 0x17, 0x00, 0x00, 0xff, 0xff, 0x51, 0x4f, 0x7f,
	0x3a, 0xd5, 0x03, 0x00, 0x00,
}
...
func (m *Query) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x52
	if m.Ttl != 0 {
		i = encodeVarintinterquery(dAtA, i, uint64(m.Ttl))
		i--
		dAtA[i] = 0x48
	}
	if len(m.CallbackId) > 0 {
		...
		i = encodeVarintinterquery(dAtA, i, uint64(len(m.CallbackId)))
		i--
		dAtA[i] = 0x42
	}
	{
	...
	if len(m.Request) > 0 {
		...
		i = encodeVarintinterquery(dAtA, i, uint64(len(m.Request)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.QueryType) > 0 {
		...
		i = encodeVarintinterquery(dAtA, i, uint64(len(m.QueryType)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ChainId) > 0 {
	...
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintinterquery(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *DataPoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintinterquery(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x22
	}
	{
...
func (m *Query) Size() (n int) {
	...
	if m.Ttl != 0 {
		n += 1 + sovinterquery(uint64(m.Ttl))
	}
