...
// source: quicksilver/interquery/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryRequestsRequest)(nil), "quicksilver.interquery.v1.QueryRequestsRequest")
	proto.RegisterType((*QueryRequestsResponse)(nil), "quicksilver.interquery.v1.QueryRequestsResponse")
	proto.RegisterType((*GetTxWithProofResponse)(nil), "quicksilver.interquery.v1.GetTxWithProofResponse")
}

func init() {
	proto.RegisterFile("quicksilver/interquery/v1/query.proto", fileDescriptor_e4aadfdae61bcbb1)
}
...
func (c *querySrvrClient) Queries(ctx context.Context, in *QueryRequestsRequest, opts ...grpc.CallOption) (*QueryRequestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/quicksilver.interquery.v1.QuerySrvr/Queries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QuerySrvr_Queries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/quicksilver.interquery.v1.QuerySrvr/Queries",
	}
...
var _QuerySrvr_serviceDesc = grpc.ServiceDesc{
	ServiceName: "quicksilver.interquery.v1.QuerySrvr",
	...
	Metadata: "quicksilver/interquery/v1/query.proto",
}
