...
// source: quicksilver/interquery/v1/messages.proto
...
func init() {
	proto.RegisterType((*MsgSubmitQueryResponse)(nil), "quicksilver.interquery.v1.MsgSubmitQueryResponse")
	proto.RegisterType((*MsgSubmitQueryResponseResponse)(nil), "quicksilver.interquery.v1.MsgSubmitQueryResponseResponse")
}

func init() {
	proto.RegisterFile("quicksilver/interquery/v1/messages.proto", fileDescriptor_0640fcbc3e895a79)
}
...
func (c *msgClient) SubmitQueryResponse(ctx context.Context, in *MsgSubmitQueryResponse, opts ...grpc.CallOption) (*MsgSubmitQueryResponseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/quicksilver.interquery.v1.Msg/SubmitQueryResponse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitQueryResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/quicksilver.interquery.v1.Msg/SubmitQueryResponse",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "quicksilver.interquery.v1.Msg",
	...
	Metadata: "quicksilver/interquery/v1/messages.proto",
}
