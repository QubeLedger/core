...
$ qubed tx oracle set-feeder qube1...

where "qube1..." is the address you want to delegate your voting rights to.
`),
...
# Aggregate Prevote
$ qubed tx oracle aggregate-prevote 1234 0.1ATOM,1.001USDT
...
$ qubed tx oracle aggregate-prevote 1234 0.1ATOM,1.001USDT qubevaloper1...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
...
$ qubed tx oracle aggregate-vote 1234 0.1ATOM,1.001USDT 
...
If voting from a voting delegate, set "validator" to the address of the validator to vote on behalf of:
$ qubed tx oracle aggregate-vote 1234 0.1ATOM,1.001USDT qubevaloper1....
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientTxContext(cmd)
			if err != nil {
