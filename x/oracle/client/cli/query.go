...
$ qubed query oracle exchange-rates 

Or, can filter with denom

$ qubed query oracle exchange-rates ATOM
`),
...
$ qubed query oracle feeder qubevaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ qubed query oracle miss qubevaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ qubed query oracle aggregate-prevotes

Or, can filter with voter address

$ qubed query oracle aggregate-prevotes qubevaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ qubed query oracle aggregate-votes 

Or, can filter with voter address

$ qubed query oracle aggregate-votes qubevaloper...
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
