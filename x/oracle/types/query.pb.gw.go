...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"github.com/QuadrateOrg/core", "oracle", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"github.com/QuadrateOrg/core", "oracle", "price", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PriceAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"github.com/QuadrateOrg/core", "oracle", "price"}, "", runtime.AssumeColonVerbOpt(true)))
)
