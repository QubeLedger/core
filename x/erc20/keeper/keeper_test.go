...
import (
	...
	"github.com/QuadrateOrg/core/contracts"
...
func (s *KeeperTestSuite) SetupTokenFactory() {
...
func (suite *KeeperTestSuite) setupRegisterERC20Pair(contractType int) common.Address {
	...
	case contractDirectBalanceManipulation:
		contract = suite.DeployContractDirectBalanceManipulation("Test", "TST")
	case contractMaliciousDelayed:
		contract = suite.DeployContractMaliciousDelayed("Test", "TST")
	default:
