...
func NewSimApp(
	...
	keys := sdk.NewKVStoreKeys(
		...
		authzkeeper.StoreKey, ibcfeetypes.StoreKey, interchainquerytypes.StoreKey,
	)
	...
	app.mm.SetOrderBeginBlockers(
		...
		paramstypes.ModuleName, vestingtypes.ModuleName, icatypes.ModuleName, ibcfeetypes.ModuleName, ibcmock.ModuleName, interchainquerytypes.ModuleName,
	)
	app.mm.SetOrderEndBlockers(
		...
		upgradetypes.ModuleName, vestingtypes.ModuleName, icatypes.ModuleName, ibcfeetypes.ModuleName, ibcmock.ModuleName, interchainquerytypes.ModuleName,
	)
	...
	app.mm.SetOrderInitGenesis(
		...
		icatypes.ModuleName, ibcfeetypes.ModuleName, ibcmock.ModuleName, feegrant.ModuleName, paramstypes.ModuleName, upgradetypes.ModuleName, vestingtypes.ModuleName, interchainquerytypes.ModuleName,
	)
...
// GetStakingKeeper implements the TestingApp interface.
func (app *SimApp) GetBankKeeper() bankkeeper.Keeper {
