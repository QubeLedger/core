...
func NewQuadrateApp(
	...
	wasmOpts = append(wasmbinding.RegisterCustomPlugins(&app.BankKeeper, app.TokenFactoryKeeper, &app.InterchainTxsKeeper, &app.InterchainQueriesKeeper, app.TransferKeeper, *app.EvmKeeper), wasmOpts...)
